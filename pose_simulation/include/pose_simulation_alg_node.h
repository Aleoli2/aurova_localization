...
#ifndef _pose_simulation_alg_node_h_
#define _pose_simulation_alg_node_h_
 ...
 *
 */
class PoseSimulationAlgNode : public algorithm_base::IriBaseAlgorithm<PoseSimulationAlgorithm>
{
private:
