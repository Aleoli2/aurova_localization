...
#ifndef _pose_simulation_alg_h_
 ...
 *
 */
class PoseSimulationAlgorithm
{
protected:
  /**
   * \brief define config type
   *
   * Define a Config type with the PoseSimulationConfig. All driver implementations
...
public:
   ...
   * will then use the same variable type Config.
   */
  typedef pose_simulation::PoseSimulationConfig Config;
  ...
  // here define all pose_simulation_alg interface methods to retrieve and set
  ...
  /**
   * \brief Generate new message of simulated pose
   *
   * This function gets information of the ackermann state, and the current pose, and calculates new pose.
   *
   * @param ackermann_state is the state of the robot (speed and steering).
